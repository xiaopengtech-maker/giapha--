...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-[#f8fafc] selection:bg-emerald-200 selection:text-emerald-900 relative overflow-hidden">
      {/* Background effects */}
      ...
      <main className="max-w-3xl mx-auto px-4 py-20 relative z-10">
        <div className="bg-white/70 backdrop-blur-xl rounded-3xl p-8 sm:p-12 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/80">
          <h1 className="text-4xl sm:text-5xl font-serif font-bold text-slate-900 mb-8">
            Giới thiệu
          </h1>

          <div className="prose prose-slate prose-lg max-w-none">
            <p className="text-slate-600 leading-relaxed mb-6">
              <strong className="text-slate-800">GiaPhaOS</strong> là một
            ...
            <p className="text-slate-600 leading-relaxed mb-2">
              <a
                ...
                className="font-semibold text-emerald-700 hover:text-emerald-600 transition-colors inline-flex items-center gap-1.5"
              >
