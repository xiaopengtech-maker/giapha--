      ...
      >
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-semibold text-emerald-800 bg-white/60 rounded-full shadow-[0_2px_10px_-3px_rgba(0,0,0,0.1)] border border-emerald-200/50 relative overflow-hidden group"
          >
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-[5rem] font-serif font-bold text-slate-900 tracking-tight leading-[1.1] max-w-4xl">
        ...
        >
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-16 bg-emerald-500/30 blur-2xl rounded-full z-0 hidden sm:block"></div>

          <Link
            href="/login"
            className="group inline-flex items-center justify-center gap-2 px-8 py-4 sm:px-10 sm:py-5 text-base sm:text-lg font-bold text-white bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-500 hover:to-emerald-600 rounded-2xl shadow-xl shadow-emerald-900/10 hover:shadow-2xl hover:shadow-emerald-900/20 transition-all duration-300 hover:-translate-y-1 active:translate-y-0 w-full sm:w-auto overflow-hidden relative"
          >
        ...
        <motion.div
          className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 text-left border-t border-slate-200/50 relative"
          variants={staggerContainer}
        >
          {[
            {
            ...
            {
              icon: <Network className="size-6 text-emerald-600" />,
            ...
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-linear-to-br from-emerald-100/50 to-transparent rounded-bl-[100px] opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

              <div className="p-3.5 bg-white rounded-2xl mb-6 shadow-sm ring-1 ring-slate-100 group-hover:scale-110 group-hover:shadow-md transition-all duration-300 relative z-10">
                {feature.icon}
              </div>
              <h3 className="text-xl sm:text-2xl font-bold text-slate-800 mb-3 font-serif relative z-10 group-hover:text-emerald-700 transition-colors">
                {feature.title}
              </h3>
